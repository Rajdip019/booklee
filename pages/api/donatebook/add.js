...
export default async (req,res)=> {
    ...
    {
        try{
            const {name, author,condition, description, photo, seller_mail, seller_id,  adress, landmark, country, state, city, pin, study, college, school} = req.body;  // Destructuring the info got from the body.
