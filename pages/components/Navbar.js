  ...
  return (
    ...
    {session && (
      ...
      <nav className="bg-white flex justify-between max-w-8xl sm:px-6 lg:px-[200px]">
        ...
        <div className="w-[25vw] flex">
          ...
          />
          <button onClick={async () => {search(); try{await props.handleFilter()}catch{}}}>
            <svg
        ...
        <div className="flex items-center">
          <span className="hidden xl:block">
            <Link href="/ListBookForSelling">
              <button className="bg-skin-lightBlue hover:bg-skin-hoverBlue text-skin-darkBlue py-2 px-4 rounded-lg mx-4 font-bold transition-all">
                Sell
              </button>
            </Link>
          </span>
          <span className="hidden xl:block">
            <Link href="/ListBookForDonating">
              <button className="bg-skin-lightGreen hover:bg-skin-hoverGreen text-skin-darkGreen py-2 px-4 rounded-lg mx-4 font-bold transition-all">
                Donate
              </button>
            </Link>
          </span>
          ...
          <Menu>
            ...
            <MenuList className=" bg-white rounded-lg p-2 w-28 shadow-lg">
              ...
              <Link href={'/profile/[uid]/admin/favourite'} as={`/profile/${id}/admin/favourite`}>
                <MenuItem className="p-1 hover:bg-skin-lightBlue transition-all rounded font-semibold">
              ...
              <MenuItem className="p-1 hover:bg-skin-lightBlue transition-all rounded font-semibold">
                <span  onClick={()=> signOut()} className="text-skin-darkBlue">Logout</span>
              </MenuItem>
            </MenuList>
          </Menu>
                    ...
                    <DrawerBody >
                      <>
                        <div className="text-center h-[97vh]">
                          <h1 className="text-3xl font-semibold py-10 font-rokkitt">Booklee</h1>
                          <hr/>
                          <Link href="/">
                            <button className="w-full  text-xl rounded-lg font-semibold text-skin-darkBlue my-2">Home</button>
                          </Link>
                          <hr />
                          <Link href={'/profile/[uid]/admin'} as={`/profile/${id}/admin`}>
                            <button className="w-full  text-xl rounded-lg font-semibold text-skin-darkBlue my-2">Profile</button>
                          </Link>
                          <hr />
                          <Link href={'/profile/[uid]/admin/favourite'} as={`/profile/${id}/admin/favourite`}>
                            <button className="w-full  text-xl rounded-lg font-semibold text-skin-darkBlue my-2">Favourite</button>
                          </Link>
                          <hr />
                          <Link href={'/profile/[uid]/admin/orders'} as={`/profile/${id}/admin/orders`}>
                            <button className="w-full  text-xl rounded-lg font-semibold text-skin-darkBlue my-2">Your Orders</button>
                          </Link>
                          <hr />
                          <button onClick={()=> signOut()} className="w-full text-xl rounded-lg font-semibold text-skin-darkBlue my-2">Logout</button>
                          <hr />
                          <Link href="/profile/sell">
                          <div className=" bottom-0 absolute mb-3 w-full left-0 py-3">
                          <hr />
                          ...
                          <div>
                           <p className="text-lg font-semibold text-left">{session?.user.name}</p>
                           <p className="text-left text-sm">{session?.user.email}</p>
                           </div>
                          </div>
                          </div>
                          </Link>
    ...
    {!session && (
      ...
      <nav className="bg-white flex justify-between max-w-8xl sm:px-6 lg:px-[200px]">
        ...
        <button className="bg-skin-lightBlue hover:bg-skin-hoverBlue text-skin-darkBlue py-2 px-4 rounded-lg mx-4 font-bold w-[100px] ">Sign In</button>
        </Link>
        </div>
      </nav>
    )}
