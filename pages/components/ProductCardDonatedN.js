    ...
    return (
        <div className='scale-90'>
            ...
            <div className="flex  mb-3 w-[266px]">
                <button className="w-[266px] rounded-b-lg bg-skin-lightGreen text-skin-darkGreen py-3 font-bold text-center text-xl cursor-default">Donated</button>
            </div>
...
export default ProductDonatedCardN
