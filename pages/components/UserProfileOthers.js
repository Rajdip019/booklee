              ...
              {session ? (
                <>
                  {mail != props.email && (
                    ...
                    >
                      <button className="text-md text-center bg-skin-lightBlue text-skin-darkBlue p-2 px-6 rounded-3xl hover:bg-blue-100 font-semibold m-4 2xl:mx-2 transition-all">
                        Message
                      </button>
                    </Link>
                  )}
