        ...
        <div className="w-[300px] text-center shadow-2xl h-[100vh] fixed hidden lg:block overflow-scroll">
          ...
          <div className="w-10/12 mx-auto">
            ...
            <div className="w-11/12 mx-auto">
                <h2 className="text-left text-xl font-semibold  my-5">Category</h2>
              <select
                value={category}
          ...
          <button className="bg-skin-lightRed text-skin-darkRed hover:bg-red-100 px-4 py-2 transition-all rounded-lg font-bold my-10 " onClick={handleReset}>Clear Filter</button>
            <button className=" bg-skin-lightBlue text-skin-darkBlue hover:bg-skin-hoverBlue px-4 py-2 transition-all rounded-lg font-bold my-10" onClick={handleFilter}>Search</button>
            </div>
          </div>
        </div>
      </ChakraProvider>
