...
const EditProfile = ({ UserDetails }) => {
  ...
  const [study, setStudy] = useState(UserDetails.study);
  const [college, setCollege] = useState(UserDetails.college);
                  ...
                  <Link href="/auth/signin">
                    <p className="bg-skin-lightBlue text-skin-darkBlue p-6 rounded-lg font-bold text-xl inline-block text-center">
                      <svg
                        ...
                        className="h-7 w-7 inline-block mr-3"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
            ...
            <>
              ...
              <form>
                <div className="ml-[4vw] md:ml-0">
                  <div className=" lg:ml-[300px] w-11/12 lg:w-[calc(100%-300px)] grid grid-col-1 md:grid-cols-4 lg:grid-cols-5 gap-0 lg:gap-10 ml-[4vw]">
                    <div className="col-span-2 md:col-span-5 lg:col-span-1 mt-10 m-auto">
                      <div className="flex flex-col">
                        ...
                        ></Avatar>
                        <span className="block md:hidden lg:block font-semibold text-center mt-3 text-lg mx-auto">
                          {session?.user?.name}
                        </span>
                        <span className="block md:hidden lg:block text-center text-sm mx-auto text-gray-700">
                          {session?.user?.email}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="col-span-2 md:col-span-1 mx-auto hidden lg:block"></div>
                  <hr className="col-span-4 w-11/12 hidden lg:block"/>
                  </div>
                  <div className="ml-[0px] lg:ml-[300px] lg:w-[calc(100%-300px)] grid grid-col-2 md:grid-cols-4 lg:grid-cols-5 gap-0 lg:gap-10">
                    <div className="col-span-2 md:col-span-1 mx-auto hidden lg:block"></div>
                    <div className=" col-span-1 md:col-span-4 mt-10">
                      <h1 className="md:col-span-4 col-span-1 lg:-mb-6 text-2xl font-medium ml-[4vw] lg:m-auto mb-5">
                        Enter College/School Details
                      </h1>
                    </div>
                    <div className=" md:col-span-1 mx-auto hidden lg:block "></div>
                    <select
                      value={study}
                      className="block lg:w-full h-[40px] pl-2 md:w-10/12 ml-[4vw] md:mx-auto col-span-2 w-11/12"
                      onChange={(e) => {
                    ...
                    {study === "college" && (
                      <select
                        className="block h-[40px] pl-2  md:w-10/12 ml-[4vw] md:mx-auto col-span-2 w-11/12 lg:mx-0 mt-5 md:mt-auto"
                        value={college}
                        onChange={(e) => {
                    ...
                    {study === "school" && (
                        ...
                        <input
                          type="text"
                          className="block h-[40px] pl-2  md:w-10/12 ml-[4vw] md:mx-auto col-span-2 w-11/12 mt-5 md:mt-auto"
                    ...
                    {college === "other" && study === "college" && (
                      <>
                        <input
                          type="text"
                          className="block h-[40px] pl-2  md:w-10/12 ml-[4vw] md:mx-auto w-11/12 lg:w-full mx-auto lg:mx-0 col-span-2 mt-5 lg:mt-0"
                  ...
                  {/* ///////////////////////////////////Adress Part//////////////////////////////// */}
                  <div className="ml-[0px] lg:ml-[300px] lg:w-[calc(100%-300px)] grid grid-col-1 md:grid-cols-4 lg:grid-cols-5 gap-0 md:gap-10 mt-5 sm-mt-0">
                    <div className="col-span-2 md:col-span-1 mx-auto hidden lg:block"></div>
                    <hr className="col-span-4 w-11/12 hidden lg:block" />
                  </div>
                  <div className="ml-[0px] lg:ml-[300px] lg:w-[calc(100%-300px)] grid grid-col-1 md:grid-cols-4 lg:grid-cols-5 gap-0 lg:gap-10">
                    <div className="col-span-2 md:col-span-1 mx-auto"></div>
                    {/* ///////////////////////////////////Edit Your Profile Personal Details//////////////////////////////// */}
                    <div className="md:col-span-4 col-span-1  mt-5 lg:-mb-6 text-2xl font-medium mb-5 ml-[4vw] lg:ml-0">
                      <h3>Adress Details</h3>
                    </div>
                    <div className="col-span-2 md:col-span-1 mx-auto lg:block hidden"></div>

                    <div className="block h-[40px] md:w-10/12 ml-[4vw] md:mx-auto w-11/12 sm:mt-auto lg:w-full mx-auto lg:mx-0 col-span-2 mt-5 lg:mt-auto">
                      <div className="mb-5">
                        <h3>Address</h3>
                        <ChakraProvider>
                          <Input
                    ...
                    <div className="md:block h-[40px] pl-2 w-10/12 lg:w-full mx-auto lg:mx-0 col-span-2 mt-5 lg:mt-auto hidden">
                      ...
                      <div className=" flex fixed bottom-0 w-screen left-[2vw]">
                        <button
                          onClick={handleSubmit}
                          type="submit"
                          className="block md:hidden bg-skin-lightGreen text-skin-darkGreen font-bold px-4 py-2 rounded-t-lg mr-6 mt-5 w-full"
                        >
                          Save
                        </button>
                      </div>
